...
void Grid::GetTopBoundary (real_t* buffer){
    BoundaryIterator iter(_geom);
    iter.SetBoundary(3);
    index_t i = 0;
    while (iter.Valid()){
        buffer[i] = Cell(iter.Down());
        iter.Next();
        i++;
    }
}
void Grid::GetLeftBoundary (real_t* buffer){
    BoundaryIterator iter(_geom);
    iter.SetBoundary(4);
    index_t i = 0;
    while (iter.Valid()){
        buffer[i] = Cell(iter.Right());
        iter.Next();
        i++;
    }
}
void Grid::GetBotBoundary (real_t* buffer){
    BoundaryIterator iter(_geom);
    iter.SetBoundary(1);
    index_t i = 0;
    while (iter.Valid()){
        buffer[i] = Cell(iter.Top());
        iter.Next();
        i++;
    }
}
void Grid::GetRightBoundary (real_t* buffer){
    BoundaryIterator iter(_geom);
    iter.SetBoundary(2);
    index_t i = 0;
    while (iter.Valid()){
        buffer[i] = Cell(iter.Left());
        iter.Next();
        i++;
    }
}
void Grid::SetLeftBoundary(real_t* bufferNew){
    BoundaryIterator iter(_geom);
    iter.SetBoundary(4);
    index_t i = 0;
    while (iter.Valid()){
...
void Grid::SetRightBoundary(real_t* bufferNew){
    BoundaryIterator iter(_geom);
    iter.SetBoundary(2);
    index_t i = 0;
    while (iter.Valid()){
...
void Grid::SetTopBoundary(real_t* bufferNew){
    BoundaryIterator iter(_geom);
    iter.SetBoundary(3);
    index_t i = 0;
    while (iter.Valid()){
...
void Grid::SetBotBoundary(real_t* bufferNew){
    BoundaryIterator iter(_geom);
    iter.SetBoundary(1);
    index_t i = 0;
    while (iter.Valid()){
